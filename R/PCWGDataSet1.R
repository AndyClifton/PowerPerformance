...
#'   variables: 
#'   \describe{\item{\code{ws.HH}}{hub-height wind speed (m/s), originally 'Hub Wind Speed'} 
#'   \item{\code{Ti.HH}}{Turbulence intensity at hub height (\%), originally 'Hub Turbulence' }
